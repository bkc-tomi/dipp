...
const ImageList = (props) => {
    ...
    if (img) {
        // 画像がある場合
        return (
            <div className="bg-gray-800 rounded-lg shadow-md p-1 h-full">
                <div 
                    className="w-full p-2 grid grid-cols-6 rounded-lg border border-gray-400 border-dashed h-full"
                    onDrop={ (e) => drop(e) }
    ...
    return (
        <div className="bg-gray-800 rounded-lg shadow-md p-1 h-full">
            <div 
                className="w-full p-2 grid grid-cols-6 rounded-lg border border-dashed h-full"
                onDrop={ (e) => drop(e) }
                onDragOver={ (e) => dragover(e) }
            >
                <div className="justify-start items-center overflow-hidden">
